...
https://github.com/OpenQuadruped/spot_mini_mini/blob/spot/spot_bullet/src/spot_ars.py
"""
...
def main():
    ...
    for foot_joint_index in foot_joint_indices.values():
          pb.enableJointForceTorqueSensor(env.spot.quadruped, foot_joint_index, enableSensor=True)
