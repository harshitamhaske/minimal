...
example: spot_bezier_env.py
https://github.com/OpenQuadruped/spot_mini_mini/blob/spot/spotmicro/GymEnvs/spot_bezier_env.py
...
class spotBezierEnv(spotGymEnv):
  ...
  """
    ...
    def __init__(self,
        ...
        self.roll_history = []  # Store roll values
        self.pitch_history = []  # Store pitch values
    ...
    def get_roll_pitch_history(self):
        """Return stored roll and pitch history"""
        return self.roll_history, self.pitch_history
